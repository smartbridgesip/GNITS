...
SoftwareSerial mySerial(7, 8); // 7 to D3-TX and 8 to D2-RX to send sensor and lat and lon data to node mcu
...
if (x >330 && x<360 && y >330 && y<370 && z>400 &&z<430) 
{
    Serial.println("accident is not detected");
    acc = 0;
}
